...
const User = () => {
  return (
    <>
      <div>
        <div className="max-w-lg mx-auto my-10 bg-white dark:bg-slate-900 dark:text-slate-200 rounded-lg shadow-md p-5">
          <img
          ...
          <p className="text-center text-slate-900 dark:text-slate-200 mt-1">
            Software Engineer
          </p>
